...
/**
 * Serves as the network endpoint for user requests for deleting a package<br><br>
 * See also:<br>
...
public class DeletePackageServlet extends SlingAllMethodsServlet {
     ...
     * Request parameters are parsed to a {@link String} with the path to a package and passed

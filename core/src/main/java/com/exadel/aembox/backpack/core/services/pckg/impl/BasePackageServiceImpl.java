...
import com.exadel.aembox.backpack.core.services.pckg.BasePackageService;
...
public class BasePackageServiceImpl implements BasePackageService {
    ...
    protected static final String DEFAULT_PACKAGE_GROUP = "AEMBox_BackPack";
    ...
    private static final String DEFAULT_THUMBNAILS_LOCATION = "/apps/aembox-backpack/assets/";
     ...
     */
    @ObjectClassDefinition(name = "AEMBox BackPack PackageService configuration")

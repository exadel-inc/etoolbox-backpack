...
public class PageReferenceSearchServiceImplTest {
    ...
    public void beforeTest() {
        ...
        context.load().json("/com/exadel/aembox/backpack/core/services/impl/page3.json", PAGE_3);
        page2Template3 = context.load().json("/com/exadel/aembox/backpack/core/services/impl/page2.json", PAGE_2).adaptTo(Page.class);

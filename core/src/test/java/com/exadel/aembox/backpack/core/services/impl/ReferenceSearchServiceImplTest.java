...
package com.exadel.aembox.backpack.core.services.impl;

import com.exadel.aembox.backpack.core.dto.repository.AssetReferencedItem;
import com.exadel.aembox.backpack.core.dto.repository.PageReferencedItem;
import com.exadel.aembox.backpack.core.dto.repository.ReferencedItem;
import com.exadel.aembox.backpack.core.dto.repository.TagReferencedItem;
import com.exadel.aembox.backpack.core.services.ReferenceService;
...
public class ReferenceSearchServiceImplTest {
    ...
    public void beforeTest() {
        // load resources
        context.load().json("/com/exadel/aembox/backpack/core/services/impl/page1.json", PAGE_1);
        context.load().json("/com/exadel/aembox/backpack/core/services/impl/page2.json", PAGE_2);
        context.create().tag("test:topics/test-tag");
        context.create().asset(ASSET_1, "/com/exadel/aembox/backpack/core/services/impl/asset.png", MINE_TYPE_PNG);
        context.create().asset(ASSET_2, "/com/exadel/aembox/backpack/core/services/impl/asset.pdf", MINE_TYPE_PDF);

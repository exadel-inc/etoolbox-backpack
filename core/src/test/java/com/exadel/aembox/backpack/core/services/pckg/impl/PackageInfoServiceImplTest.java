...
public class PackageInfoServiceImplTest extends Base {
    ...
    public static class GetPackageInfo extends Base {
        ...
        private static final String TEST_ZIP = "/etc/packages/AEMBox_BackPack/test.zip";
        private static final String TEST = "test";
        private static final String PACKAGE_PATH = "/etc/packages/AEMBox_BackPack/testPackage-1.zip";
